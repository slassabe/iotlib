# Makefile for creating and uploading Python distribution packages
...
#ESCRIPTION = Less is More - Powering Your IoT Solutions with MQTT integration
#URL = https://github.com/slassabe/iotli
